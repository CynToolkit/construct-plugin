...
Download Latest Version : [Version: 2.7.0](https://github.com/CynToolkit/construct-plugin/releases/latest) <br>
...
| On "GetSteamUILanguage" success | Trigger when the "GetSteamUILanguage" is executed with success. | Tag *(string)* <br> |
| On any "GetSteamUILanguage" success | Trigger when any of the "GetSteamUILanguage" are executed with success. |  |
| On "GetSteamUILanguage" error | Trigger when the "GetSteamUILanguage" failed to execute. | Tag *(string)* <br> |
| On any "GetSteamUILanguage" error | Trigger when any of the "GetSteamUILanguage" failed to execute. |  |
| On "GetAvailableGameLanguages" success | Trigger when the "GetAvailableGameLanguages" is executed with success. | Tag *(string)* <br> |
| On any "GetAvailableGameLanguages" success | Trigger when any of the "GetAvailableGameLanguages" are executed with success. |  |
| On "GetAvailableGameLanguages" error | Trigger when the "GetAvailableGameLanguages" failed to execute. | Tag *(string)* <br> |
| On any "GetAvailableGameLanguages" error | Trigger when any of the "GetAvailableGameLanguages" failed to execute. |  |
| On "GetCurrentGameLanguage" success | Trigger when the "GetCurrentGameLanguage" is executed with success. | Tag *(string)* <br> |
...
| Is Pipelab | Return true if the Pipelab is used to run the game |  |
...
| Is overlay active | Return true if the Steam overlay is currently active. |  |
...
| GetSteamUILanguageError | The error of the "GetSteamUILanguage last call" | string |  | 
| GetSteamUILanguageResult | The result of the "GetSteamUILanguage last call" | string |  | 
| GetAvailableGameLanguagesError | The error of the "GetAvailableGameLanguages last call" | string |  | 
| GetAvailableGameLanguagesResult | The result of the "GetAvailableGameLanguages last call" | string |  | 
| GetCurrentGameLanguageError | The error of the "GetCurrentGameLanguage last call" | string |  | 
| GetCurrentGameLanguageResult | The result of the "GetCurrentGameLanguage last call" | string |  | 
