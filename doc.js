...
const pathMappings = [
  ...
  { name: "LocalUserDataFolder", desc: "Legacy app-specific local data path. Kept for backwards compatibility.", win: "C:/Users/user/AppData/Local/com.pipelab.app", linux: "$XDG_DATA_HOME/com.pipelab.app, or Electron appData fallback (commonly ~/.config/com.pipelab.app) when unset", mac: "/Users/user/Library/Application Support/com.pipelab.app" },
  { name: "SaveDataFolder", desc: "App-specific persistent game saves", win: "%LOCALAPPDATA%/com.pipelab.app", linux: "$XDG_DATA_HOME/com.pipelab.app (or ~/.local/share/com.pipelab.app when unset or invalid)", mac: "~/Library/Application Support/com.pipelab.app" },
